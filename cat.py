...
# args
#input_path = './input/cat_up.png'
input_path = '/content/gdrive/MyDrive/Sketch-Generation-with-Drawing-Process-Guided-by-Vector-Flow-and-Grayscale-main/input/cat_up.png'
#output_path = './output' 
output_path ='/content/gdrive/MyDrive/Sketch-Generation-with-Drawing-Process-Guided-by-Vector-Flow-and-Grayscale-main/output'

np.random.seed(1)
n =  6                  # Quantization order
