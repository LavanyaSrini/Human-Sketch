...
# args
#input_path = './input/ztfn_up.png'
input_path = '/content/gdrive/MyDrive/Sketch-Generation-with-Drawing-Process-Guided-by-Vector-Flow-and-Grayscale-main/input/R20.png'
#output_path = './output' 
